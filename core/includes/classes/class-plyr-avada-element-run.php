...
class Plyr_Avada_Element_Run {
	 ...
	 * All audio player styles and scripts are now loaded conditionally when the element is used.
	 *
	 * @access public
	 * @return void
	 * @since 1.0.0
	...
	public function enqueue_frontend_scripts_and_styles(): void {
		// All styles and scripts are now loaded conditionally when the audio element is used
		// This ensures optimal performance and proper CSS cascade order

		// Remove all global loading - everything loads conditionally now
		// wp_enqueue_style('frontend-styles', PLYRAE_PLUGIN_URL . 'core/includes/assets/css/frontend-styles.css', array(), PLYRAE_VERSION, 'all');
